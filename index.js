        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <div class="card-body bg-warning">
                    <h5 class="card-title ">Bestätigt : ${stats.confirmed.value}</h5>
                </div>
                </div>
            </div>
            <div class="col-sm-4">
                ...
                <div class="card-body bg-success">
                    <h5 class="card-title">Geheilt : ${stats.recovered.value}</h5>
                </div>
                </div>
            </div>
             <div class="col-sm-4">
                ...
                <div class="card-body bg-danger">
                    <h5 class="card-title">Verstorben : ${stats.deaths.value}</h5>
                </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12 mt-4">Daten aktualisiert am ${niceDate}</div>
        </div>
    `;
